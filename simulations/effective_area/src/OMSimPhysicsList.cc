...
void OMSimPhysicsList::ConstructProcess() {
    ...
    while ((*theParticleIterator)()) {
        ...
        if (particleName == "e+") {
            ...
            physicsHelper->RegisterProcess(new G4MuMultipleScattering(), particle);
            physicsHelper->RegisterProcess(new G4MuIonisation(), particle);
            physicsHelper->RegisterProcess(new G4MuBremsstrahlung(), particle);
            physicsHelper->RegisterProcess(new G4MuPairProduction(), particle);
        }
